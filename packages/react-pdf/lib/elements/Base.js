...
var Base = function () {
  function Base(root, props) {
    ...
    this.layout = _bin2.default.Node.createDefault();
  ...
  _createClass(Base, [{
    ...
    value: function applyStyle(attribute, value) {
      ...
      switch (attribute) {
        case 'marginTop':
          this.layout.setMargin(_bin2.default.EDGE_TOP, value);
          break;
        case 'marginRight':
          this.layout.setMargin(_bin2.default.EDGE_RIGHT, value);
          break;
        case 'marginBottom':
          this.layout.setMargin(_bin2.default.EDGE_BOTTOM, value);
          break;
        case 'marginLeft':
          this.layout.setMargin(_bin2.default.EDGE_LEFT, value);
          break;
        case 'paddingTop':
          this.layout.setPadding(_bin2.default.EDGE_TOP, value);
          break;
        case 'paddingRight':
          this.layout.setPadding(_bin2.default.EDGE_RIGHT, value);
          break;
        case 'paddingBottom':
          this.layout.setPadding(_bin2.default.EDGE_BOTTOM, value);
          break;
        case 'paddingLeft':
          this.layout.setPadding(_bin2.default.EDGE_LEFT, value);
          break;
        case 'borderTopWidth':
          this.layout.setBorder(_bin2.default.EDGE_TOP, value);
          break;
        case 'borderRightWidth':
          this.layout.setBorder(_bin2.default.EDGE_RIGHT, value);
          break;
        case 'borderBottomWidth':
          this.layout.setBorder(_bin2.default.EDGE_BOTTOM, value);
          break;
        case 'borderLeftWidth':
          this.layout.setBorder(_bin2.default.EDGE_LEFT, value);
          break;
        case 'position':
          this.layout.setPositionType(value === 'absolute' ? _bin2.default.POSITION_TYPE_ABSOLUTE : _bin2.default.POSITION_TYPE_RELATIVE);
          break;
        case 'top':
          this.setPosition(_bin2.default.EDGE_TOP, value);
          break;
        case 'right':
          this.setPosition(_bin2.default.EDGE_RIGHT, value);
          break;
        case 'bottom':
          this.setPosition(_bin2.default.EDGE_BOTTOM, value);
          break;
        case 'left':
          this.setPosition(_bin2.default.EDGE_LEFT, value);
          break;
        default:
    ...
    value: function getComputedPadding() {
      return {
        top: this.layout.getComputedPadding(_bin2.default.EDGE_TOP),
        right: this.layout.getComputedPadding(_bin2.default.EDGE_RIGHT),
        bottom: this.layout.getComputedPadding(_bin2.default.EDGE_BOTTOM),
        left: this.layout.getComputedPadding(_bin2.default.EDGE_LEFT)
      };
    }
  }, {
